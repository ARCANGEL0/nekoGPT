...
import { Animator, FrameBase, FrameOctagon, useBleeps } from "@arwes/react"
    ...
    <Animator duration={{ enter: 0.14, exit: 0.09 }}>
      <Comp
        ...
        className={cn(
          ...
          frame === "octagon" && "arwes-octagon-button"
        )}
        {...props}
      ...
      >
        ...
        <span className="arwes-button-content">
          {childrenArePlainText ? (
            <ArwesTypedText as="span" text={String(props.children)} trigger={String(props.children)} />
          ) : (
            props.children
          )}
        </span>
